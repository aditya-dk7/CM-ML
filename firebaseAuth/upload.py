...
person_temperature = str(sys.argv[2])
results_for_storage = storage.child(userIDGet).child(
    dateTimeCurrent).put(imageFileName, user['idToken'])
...
data = {
    ...
    "userTemperature": person_temperature
}
